...
class InpaintingModel(BaseModel):
    def __init__(self, config):
        ...
        generator = InpaintGenerator(contextual_attention=config.USE_CA, ksize=config.CA_KSIZE, use_objmasks=config.OBJMASK, skip_connections=config.SKIP_CONNECTIONS)
